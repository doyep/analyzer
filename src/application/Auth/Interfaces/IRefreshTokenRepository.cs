...
{
    /// <summary>
    /// Finds a refresh token by its hashed value. This method is typically used during the token refresh process to validate the provided refresh token.
    /// </summary>
    /// <param name="hashedToken">The hashed refresh token to find.</param>
    ...
    /// <summary>
    /// Revokes all active refresh tokens associated with the specified Strava athlete ID and device ID.
    /// </summary>
    /// <param name="stravaAthleteId">The Strava athlete ID for which to revoke active refresh tokens.</param>
    /// <param name="deviceId">The device ID for which to revoke active refresh tokens.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    Task RevokeByStravaAthleteIdAndDeviceIdAsync(long stravaAthleteId, Guid deviceId);
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    Task RevokeAsync(string hashedRefreshToken);
}
